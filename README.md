...
└── src/
    ...
    └── templates/
        ...
        └── admin/
            ...
            └── keyword_edit.html # Edit a keyword
```
...
- `/admin/candidates` — triage keyword candidates extracted from the corpus (mark as *useful*, *math*, or *ignore*)
- `/admin/keywords` — list/edit/delete curated keywords, adjust relevance scores (1–10)

### Auto-tagging

Run manually after adding/editing keywords:
...
- **`tags`** / **`paper_tags`** — MSC-code tag system (pre-populated with common combinatorics codes)
...
- **`/admin/retag`** web route to trigger `auto_tag.py` from the browser (currently CLI-only)
