...
STOPWORDS = {
    ...
    'introduce', 'introduced', 'present', 'paper', 'work', 'result', 'results',
    ...
    'above', 'added', 'adding', 'additionally', 'admit', 'admitting', 'acute', 'after', 'al', 'algorithm', 'allow', 'allowing',
    ...
    'clear', 'closely', 'combination', 'combinatorial', 'combine', 'combining', 'common', 'compare', 'competition',
    'concerning', 'conjecture', 'conjectured', 'connecting', 'connection', 'consideration', 'consisting',
    'construct', 'constructed', 'constructing', 'construction', 'constructive', 'contain', 'containing', 'conventional', 'counting', 'current', 'cutting', 'declaring',
    'deep', 'define', 'denote', 'denoted', 'denoting', 'depend', 'depending', 'describe', 'describing',
    'determine', 'determined', 'determining', 'differ', 'direction', 'disjoint', 'draw', 'dynamic',
    'compute', 'computed', 'computing', 'condition', 'constant', 'due', 'easier', 'easily', 'effective', 'efficient', 'efficiently',
    ...
    'existence',
    'fairly', 'few', 'finally', 'formalism', 'full', 'furthermore', 'gave',
    'generalization', 'generalize', 'generalized', 'generalizing',
    'generalise', 'generalised', 'generalising', 'generating', 'generic', 'graded',
    'having', 'her', 'hidden', 'him', 'his', 'historic',
    'holding', 'holds', 'immediate', 'immediately', 'implicit', 'improve', 'improved', 'improving',
    'include', 'including', 'inclusion', 'independent', 'independently', 'infinite', 'influence', 'initial',
    'instance', 'interest', 'intermediate', 'isomorphism',
    'interesting', 'intuition', 'investigate', 'involving', 'large', 'largest', 'lead', 'leading', 'leads',
    'labelled', 'left', 'lemma', 'literature', 'london', 'lying',
    'mamarim', 'mamarimhtml', 'math', 'me', 'mentioned', 'method', 'much', 'mxn',
    'near', 'needed', 'newly', 'next', 'nice', 'non-empty', 'notion', 'nontrivial', 'novelli', 'n-th', 'observe', 'observing', 'occur', 'particular', 'particularly',
    'off', 'often', 'ordinary', 'orthant',
    'occurring', 'obvious', 'parameter', 'part', 'per', 'perhaps', 'place', 'possible', 'precisely',
    'pak', 'pp', 'preserving', 'pretty', 'previous', 'previously', 'probably', 'problem', 'programming', 'provide',
    ...
    'slow', 'small', 'so-called', 'solvable', 'specified', 'staller', 'stated', 'sum', 'swap', 'systematic',
    'straightforward', 'structural', 'structure', 'subject', 'successively', 'sufficiently', 'suppose', 'supposing',
    'take', 'technique', 'technology', 'them', 'theoretic', 'thereof', 'thereby', 'thesis', 'triangle', 'trivial', 'turn', 'typical',
    'under', 'underlying', 'unexpected', 'unique', 'us', 'usual', 'variation', 'verifying', 'version',
